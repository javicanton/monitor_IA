...
|--------|--------|----------|
| `run_scraper_full.sh` | Una vez (backfill) | Hasta 10 000 msg/canal, sin límite de días |
| `run_scraper_daily.sh` | Cada día (cron) | Últimos 3 días, hasta 500 msg/canal |
| `run_scraper_postgres.sh` | Manual / legacy | Parámetros por `.env` (`SCRAPER_DAYS`, `SCRAPER_MAX_MESSAGES`) |
